...
%	derivsRK	Right hand side of ODE; derivsRK is the name
%			of the function which returns dx/dt
...
tSave = 1;	xSave = x;	% Save initial values
save1 = 0.9;	save2 = 4.;	% Safety factors

% Loop over the minimum number of attempts to satisfy error bound
maxTry = 100;
...
For iTry = 1:maxTry
	...
	tau_old = tau;
	tau = safe1*tau_old*errorRatio^(0.2);
...
%* Issue error message if error bound was not satisfied
